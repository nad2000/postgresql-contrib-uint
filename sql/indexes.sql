...
COPY hash_uint1_heap FROM '/home/rad.cirskis/postgresql-contrib-uint/data/uint1_hash.data';
...
COPY hash_uint2_heap FROM '/home/rad.cirskis/postgresql-contrib-uint/data/uint2_hash.data';
...
COPY hash_uint4_heap FROM '/home/rad.cirskis/postgresql-contrib-uint/data/uint4_hash.data';
